...
const url = 'mongodb+srv://gotham:G0thamXmong0@journal.4ok3oge.mongodb.net/journal?retryWrites=true&w=majority' //process.env.DB_conn
mongoose.set('strictQuery', false)
try{mongoose.connect(url,{useNewUrlParser : true})}
catch(err){console.log("connectoin failed")}
/////////////////////////////////////////////////////////////////////////////////
